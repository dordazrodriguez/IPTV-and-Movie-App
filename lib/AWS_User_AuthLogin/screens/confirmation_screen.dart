          ...
          builder: (BuildContext context) => Container(
                child: Form(
                  ...
                  child: ListView(
                      ...
                      Center(
                        child: InkWell(
                          child: Text(
                            ...
                            style: TextStyle(color: Colors.blueAccent, fontSize: screenSize.height * .025),
                          ),
                          onTap: () {
                    ...
                    Padding(
                      child: Center(
                        child: Text('Confirmation code or link has been sent to your email.', 
                        style: TextStyle(fontSize: MediaQuery.of(context).size.width * .015),)),
